...
- [x] 5. Implement Customer module
  - [x] 5.1 Tạo `Customer` entity và `CustomerRepository`
  ...
  - [x] 5.2 Tạo `CustomerService` với đầy đủ business logic
  ...
  - [x] 5.3 Tạo `CustomerController` với các DTO request/response
...
- [ ] 7. Implement Order module
  - [x] 7.1 Tạo `Order`, `OrderItem` entity và các Repository
    - Tạo JPA entity `Order` với trường `active` (boolean, soft delete) và `code` (HD0000001)
  ...
  - [x] 7.2 Tạo `Debt` entity và `DebtRepository`
  ...
  - [x] 7.3 Tạo `OrderService` với đầy đủ business logic
    ...
    - Implement `deleteOrder`: soft delete (active = false)
    - _Requirements: 4.1, 4.2, 4.3, 4.4, 4.5, 4.6, 4.7, 4.8, 4.9_

  - [x] 7.4 Tạo `OrderController` với các DTO request/response
    ...
    - Implement 5 endpoints: POST, GET, GET `/{id}`, PATCH `/{id}/note`, DELETE `/{id}`
    - _Requirements: 4.1, 4.6, 4.7, 4.9_

  - [ ]* 7.5 Viết unit test cho `OrderService`
    - Test happy path: tạo order với nhiều items, lấy danh sách, lấy chi tiết, cập nhật note, soft delete
  ...
  - [ ]* 7.6 Viết property test cho Order (P8, P9, P10)
...
- [x] 8. Implement Debt module
  - [x] 8.1 Tạo `DebtService` với logic tính công nợ
...
- [x] 9. Implement Payment module
  - [x] 9.1 Tạo `Payment` entity và `PaymentRepository`
  ...
  - [x] 9.2 Tạo `PaymentService` với logic trừ nợ FIFO
  ...
  - [x] 9.3 Tạo `PaymentController` với các DTO request/response
...
- [x] 11. Implement Statistics module
  - [x] 11.1 Tạo `StatisticsService` với các aggregate queries
  ...
  - [x] 11.2 Tạo `StatisticsController`
